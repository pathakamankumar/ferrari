const CarouselSlider = () => {
    return (
        <>
            ...
            {/* <div class="w-full m-auto">
                <div id="default-carousel" class="relative mb-4 mt-4 ml-4" data-carousel="static">
                    <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                        <div class="hidden duration-700 w-96 h-96 ease-in-out" data-carousel-item>
                            <span class="absolute top-1/2 left-1/2 text-2xl font-semibold text-white -translate-x-1/2 -translate-y-1/2 sm:text-3xl dark:text-gray-800">First Slide</span>
                            <img src="https://media.zigcdn.com/media/content/2022/Nov/cover_638487d746b00_640x480.jpg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..." />
                        </div>
            ...
            {/* <div className="amanContainer">
                <a href="#" className="aman">B
                <span></span>
                <span></span>
                <span></span>
                <span></span>
